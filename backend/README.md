...
## Project Structure
    ...
    ├── testfigma_user_dev_22682  # Django project configurations
...
1. Clone this repo and `cd testfigma_user_dev_22682`
...
2. Clone this repo and `cd testfigma_user_dev_22682`
